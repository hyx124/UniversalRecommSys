...
public class UrsInputSpout extends TdbankSpout {
	...
	private String[] genItemDetailMsg(String event){
		String impDate = "0";
		String bid = "10070002";
		String itemId = "0";
		...
		String[] dealMsg ={impDate,bid,itemId,categoryId1,categoryId2,categoryId3,
