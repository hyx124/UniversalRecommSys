...
public class ARCFBoltStep2 extends AbstractConfigUpdateBolt{
	/**
	 * 
	 */
	...
	private static Logger logger = LoggerFactory.getLogger(ARCFBoltStep2.class);

	@SuppressWarnings("rawtypes")
	public ARCFBoltStep2(String config, ImmutableList<Output> outputField){
