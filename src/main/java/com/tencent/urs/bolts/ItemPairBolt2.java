...
public class ItemPairBolt2  extends AbstractConfigUpdateBolt{
	...
	private static Logger logger = LoggerFactory
			.getLogger(ItemPairBolt2.class);
	
	public ItemPairBolt2(String config, ImmutableList<Output> outputField){
